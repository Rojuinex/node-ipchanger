...
var ProxyServer, colors, config, currentProxy, db, forwardServer, hideMyAssGrabber, http, httpServer, jsdom, lastChange, mongoose, net, prop, proxyServerStarted, qs, setupDatabase, setupGrabbers, startProxyServer, startServer, updateProxy, updating, util;
...
process.on('uncaughtException', function(err) {
  ...
  return console.error(err.stack + reset);
});
...
startProxyServer = function() {
  ...
  forwardServer = net.createServer(function(clientSocket) {
    var buffers, changing, connected, proxySocket;
