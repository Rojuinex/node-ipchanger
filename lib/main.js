...
var ProxyServer, colors, config, currentProxy, db, hideMyAssGrabber, http, jsdom, lastChange, mongoose, net, prop, qs, server, setupDatabase, setupGrabbers, startServer, updateProxy, util;
...
startServer = function() {
  ...
  forwardServer = net.createServer(function(clientSocket) {
    var buffers, changing, connect, connected, connectionReset, proxySocket;
    ...
    connect = function() {
      proxySocket = new net.Socket();
      return proxySocket.connect(currentProxy.port, currentProxy.ipaddress, function() {
