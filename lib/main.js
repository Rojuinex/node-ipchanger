...
var ProxyServer, colors, config, currentProxy, db, hideMyAssGrabber, http, jsdom, lastChange, mongoose, net, prop, qs, server, setupDatabase, setupGrabbers, startServer, updateProxy, updating, util;
